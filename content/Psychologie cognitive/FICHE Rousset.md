...
---
## 🎯 Objectifs
- Être capable d’expliquer le cours à une personne qui ne l’a pas suivi.
- Relier les notions entre elles et les replacer dans leur cadre théorique.
- Décrire les modèles, leur fonctionnement, et les expériences qui les justifient.
- Connaître avantages, limites et paradigmes associés.
...
### Méthodologie
- **Introspection** bannie → un système ne peut être à la fois objet et sujet de l’étude.
- **Analogie à modèle** : on suppose qu’un processus psychologique fonctionne *comme* un autre système connu (ex: mémoire = ruban magnétique).  
  - On teste si les comportements observés correspondent aux prédictions.
  - ⚠️ On ne prouve jamais un modèle vrai → seulement moins faux qu’un autre.
...
- **Exemple** : tâche du rappel sériel à court terme (longueur des mots).
...
|---------------------|-------------------------------------------|----------------|-----------|
| **Computationnel** | But du système                            | Aspirer        | Traiter l’info |
| **Algorithmique**  | Principes, outils de traitement           | Ventilateur    | Fonctions cognitives |
| **Implémentation** | Substrat physique                         | Moteur/élec.   | Neurones |
...
### Exemple expérimental : effet de supériorité du prototype
- Apprentissage de dérivations d’un stimulus → en test, le **prototype jamais vu** est mieux reconnu.  
- Montre que les sujets créent une représentation globale.
...
4. Appariement avec mémoire.  
- **Agnosies perceptives** : trouble des représentations.  
- **Agnosies associatives** : incapacité de relier perception ↔ connaissances.
...
|--------------------|------------------|------------------------------------|
| **Procédurale**   | Anoétique        | Habitudes motrices (sans conscience) |
| **Sémantique**    | Noétique         | Connaissances générales, invariants |
...
### Expériences
- **Geais** : récupération ordonnée de nourriture → mémoire épisodique animale.  
- **Effet de profondeur d’encodage** : traitement sémantique → rappel supérieur.
...
## 7. Conceptions de la mémoire

### Abstractive
- Mémoire = **stock de représentations** (encodage → stockage → récupération).  
...
## 8. Synthèse et limites
| Approche          | Forces                                   | Limites                                |
|-------------------|------------------------------------------|----------------------------------------|
| **Behaviourisme** | Lois empiriques, prédiction              | Pas d’explication, faible écologie     |
| **Abstractif**    | Organisation structurée, invariants      | Rigidité, contexte mal expliqué        |
| **Non-abstr.**    | Flexibilité, rôle du contexte, multi-traces | Difficulté à modéliser, calcul complexe |
